...
namespace LockApp
{
    public class StatusProvider : INotifyPropertyChanged
    {
        ...
        public bool IsVisible { get => (bool)GetValue(); set => SetValue(value); }
    }
    ...
    public class LockInfo : INotifyPropertyChanged
    {
        ...
        public bool IsDetailedStatusVisible { get => (bool)GetValue(); set => SetValue(value); }

        public StatusProvider BatteryStatusProvider { get => (StatusProvider)GetValue(); set => SetValue(value); }
        public StatusProvider NetworkStatusProvider { get => (StatusProvider)GetValue(); set => SetValue(value); }
    }
}
